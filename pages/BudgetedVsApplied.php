                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left" id="ContainerTitle">Budgeted vs Applied</h4>
                                    ...
                                    <table id="dataTable" class="table table-bordered table-striped">
                                        <thead class="text-capitalize">
                                            <tr>
                                                ...
                                                <th width="25%" style="background-color:#7855ed; color:white;">Project Name</th>
                                                <th width="%10" style="background-color:#7855ed; color:white;">Budgeted Amount</th>
                                        ...
                                        <?php
                                            ...
                                            $stmts = $GlobalConnection->runQuery("SELECT * FROM apollo_contractamount_approval WHERE approval_status ='Approved'");
                                            $stmts->execute();
                                                ...
                                                {   
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>₱<?php echo $rows['budgeted_amount']?></td>
                                                        <td>₱
                                                            <?php 
                                                                $a = $rows['contract_amount']; 
                                                                $b = str_replace( ',', '', $a );
                                                                echo number_format($b, 2);
                                                            ?>
                                                        </td>
                                                        <?php
                                                        if($rows['contract_amount'] > $rows['budgeted_amount']){
                                                            ?>
                                                                <td><h6><span class="badge badge-danger"><?php echo 'Over Budget'?></span></h6></td>
                                                            <?php
                                                        }
                                                        else{
                                                            ?>
                                                                <td><h6><span class="badge badge-success"><?php echo 'N/A'?></span></h6></td>
                                                            <?php
                                                        }
