                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left" id="ContainerTitle">Rejected Billing Approval</h4>
                    ...
                    <div id="AlertMessage"></div>
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Rejected Billing List</h4>
                                    ...
                                    <table id="dataTable" class="table table-bordered table-striped">
                                        <thead class="text-capitalize">
                                            <tr>
                                                ...
                                                <th width="25%" style="background-color:#7855ed; color:white;">Contractor</th>
                                        ...
                                        <?php
                                            ...
                                            $stmts = $GlobalConnection->runQuery("SELECT * FROM apollo_firstapprover WHERE billing_status='Rejected'");
                                            $stmts->execute();
                                                ...
                                                {   
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td data-toggle="tooltip" data-placement="Left" title="<?php echo $rows['remarks']?>"><?php echo $rows['remarks']?></td>
                                                            ...
                                                            <td>
                                                             <button type="button" class="btn btn-warning btn-xs mb-2" value="<?php echo $rows['b_id']?>" onclick="BackToEo(this.value)">Back to Eo</button>
                                                             <button type="button" class=" btn btn-success btn-xs mb-2" data-toggle="modal" data-target="#exampleModalLong<?php echo $rows['b_id']?>">Reapprove</button>
                                                            </td>
                                                       ...
                                                       <div class="modal-dialog">
                                                           <div class="modal-content">
                                                               ...
                                                               <div class="modal-footer">
                                                                   ...
                                                                   <button type="button" class="btn btn-success" id="BtnReject" value="<?php echo $rows['billing_type']?>" onclick="ReapproveButton(this.value,<?php echo $rows['b_id']?>)">For Approval</button>
                                                               </div>
                                                           </div>
                                                       </div>
                                                   </div>
