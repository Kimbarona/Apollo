                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left" id="ContainerTitle">Rejected Billing </h4>
                                ...
                                <div class="table-responsive">
                                    <table id="dataTable" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                            ...
                                            $stmts = $GlobalConnection->runQuery("SELECT * FROM apollo_rejectedapproval_history WHERE engineer='$fullname'");
                                            $stmts->execute();
                                                ...
                                                {   
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td data-toggle="tooltip" data-placement="Left" title="<?php echo $rows['remarks']?>"><?php echo $rows['remarks']?></td>                                                      
                                                            <td>
                                                             <button type="button" class=" btn btn-info btn-xs mb-2" data-toggle="modal" data-target="#exampleModalLong">View Instruction</button>
                                                            </td>                                                     
                                                    </tr>
                                                       ...
                                                       <div class="modal-dialog">
                                                           <div class="modal-content">
                                                               <div class="modal-header">
                                                                   <h5 class="modal-title">Read Instruction</h5>
                                                                   <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                                                               </div>
                                                               <div class="modal-body">
                                                                   <p>
                                                                        This billing is already rejected due to some reasons, you need to generate new billing base on the progress needed.
                                                                        since, this billing is rejected you can not process this anymore unless generate new billing.
                                                                        to continue just consult to your Head to start new billing.
