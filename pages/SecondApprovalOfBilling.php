...
<head>
    ...
    <script src="SecondApprovalOfBilling.js"></script>
                                ...
                                <div class="table-responsive">
                                    <table id="dataTable" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                            ...
                                            $stmts = $GlobalConnection->runQuery("SELECT apollo_secondapprover.b_id, apollo_secondapprover.capex_number, apollo_enrolledproject.project_name, apollo_secondapprover.contractor,
                                            apollo_secondapprover.billing_type, apollo_secondapprover.progress, apollo_secondapprover.billable_amount, apollo_secondapprover.billing_status, apollo_secondapprover.remarks FROM `apollo_secondapprover`
                                            LEFT JOIN apollo_enrolledproject
                                            ON apollo_secondapprover.capex_number = apollo_enrolledproject.capex_number 
                                            WHERE apollo_secondapprover.billing_status='For Approval'
                                            AND approver_name ='$fullname'");
                                            $stmts->execute();
                                                    ...
                                                    <tr>
                                                       ...
                                                       <?php
                                                        ...
                                                        if($rows['billing_status']=='Approved'){
                                                            ...
                                                            <a href="secondviewing.php?id=<?php echo $rows['capex_number']?>" class="btn btn-info btn-xs mb-2 fa fa-eye" value=""> View</a>
                                                            </td>
                                                            <?php
                                                        }
                                                        ?>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" class="btn btn-success" id="BtnReject" value="<?php echo $rows['billing_type']?>" onclick="RejectFunction(this.value,<?php echo $rows['b_id']?>)">Reject</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    function ApproveButton(id){       
        $.ajax({
            type: "POST",
            url: "Approvers/SecondApproverPosting.php",
            data: {Id:id},
