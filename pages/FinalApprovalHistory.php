                                ...
                                <div class="table-responsive">
                                    <table id="dataTable" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                            ...
                                            $stmts = $GlobalConnection->runQuery("SELECT * FROM apollo_fourthapprover WHERE billing_status ='approved' AND approver_name ='$fullname' AND billing_status='Approved'");
                                            $stmts->execute();
