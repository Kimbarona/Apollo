...
<head>
    ...
    <script src="ThirdApprovalOfBilling.js"></script>
                                ...
                                <div class="table-responsive">
                                    <table id="dataTable" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                            ...
                                            $stmts = $GlobalConnection->runQuery("SELECT apollo_thirdapprover.b_id, apollo_thirdapprover.capex_number, apollo_enrolledproject.project_name, apollo_thirdapprover.contractor,
                                            apollo_thirdapprover.billing_type, apollo_thirdapprover.progress, apollo_thirdapprover.billable_amount, apollo_thirdapprover.billing_status, apollo_thirdapprover.remarks FROM `apollo_thirdapprover`
                                            LEFT JOIN apollo_enrolledproject
                                            ON apollo_thirdapprover.capex_number = apollo_enrolledproject.capex_number 
                                            WHERE apollo_thirdapprover.billing_status='For Approval'
                                                    ...
                                                    <tr>
                                                       ...
                                                       <?php
                                                        ...
                                                        if($rows['billing_status']=='Approved'){
                                                            ...
                                                            <a href="thirdviewing.php?id=<?php echo $rows['capex_number']?>" class="btn btn-info btn-xs mb-2 fa fa-eye" value=""> View</a>
                                                            </td>
                                                            <?php
                                                        }
                                                        ?>
...
<script>
    function ApproveButton(id){       
        $.ajax({
            type: "POST",
            url: "Approvers/ThirdApprovalPosting.php",
            data: {Id:id},
